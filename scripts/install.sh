...
sudo install -vDm644 "${REL_PATH}/target/loc/io.github.plrigaux.sysd-manager.metainfo.xml" -t "/usr/share/metainfo"
sudo install -vDm644 "${REL_PATH}/data/metainfo/io.github.plrigaux.sysd-manager.releases.xml" -t "/usr/share/metainfo/releases"
