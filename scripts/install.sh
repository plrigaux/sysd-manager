...
sudo install -Dm644 "${REL_PATH}/data/applications/io.github.plrigaux.sysd-manager.desktop" -t "/usr/share/applications"
...
sudo cp -r -v "${REL_PATH}/target/locale/"  "/usr/share/locale/" 
